...
│   │── __init__.py         # (opsional) Menandai folder sebagai package
│
...
-Semua operasi seperti tambah data, lihat data, hingga analisis dilakukan melalui menu interaktif.
